                                                                ...
                                                                <div class="col-md-6 col-lg-6 col-sm-12">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <select id="inputState" class="form-control">
                                                                            <option selected="selected" name="g_year" value="0">Select
                                                                                One</option>
                                                                            <option value="2001">2001</option>
                                                                            <option value="2002">2002</option>
                                                                            <option value="2003">2003</option>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <input type="text" class="form-control" name="posting"
                                                            id="posting" placeholder="Place of Posting"
                                            ...
                                            <div class="card-body" id="section_10_content">
                                                ...
                                                <div class="form-group">
                                                    <label class="form-label" for="article">Publications &
                                                        Articles:</label>
                                                    <input type="text" class="form-control"
                                                        placeholder="Publications & Articles" name="article"
                                                        id="article" value="<?php echo  $W_ARTICLE; ?>">
                                                </div>
                                                <!-- article ends  -->
