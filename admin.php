    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-10 p-0">
                <div class="row m-0" style="height:22%!important">
                ...
                <div class="row col-12 m-0">
                    <!-- form stars 		 -->
                    <form action="" method="POST" enctype="multipart/form-data" class="col-12" id="event">
                                ...
                                <div class="card " style="width: 95%">
                                    <div class="card-header " style="background-color: #C0C0C0!important;">
                                        <div class="d-flex justify-content-center align-items-center">
                                            <p class="section_part btn btn-link" id="section_12_label"
                                                style="font-size:2vw;">Section : Event Description
                                            </p>
                                        </div>
                                    ...
                                    <div class="card-body" id="section_12_content">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="form-group row">
                                                <label for="e_name">Event Date:</label>
                                                <input type="date" class="form-control" placeholder="Enter event name"
                                                    name="e_date" id="e_date">
                                            </div>
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <textarea rows="6" cols="20" name="e_desc" form="event"
                                                    class="form-control col-12 d-block mt-4">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center">
                                            ...
                                            <div class="form-group row ">
                                                <label for="e_amount" class="d-block">Event Charge:</label><br>
                                                <input type="number" class="form-control"
                                                    placeholder="Enter event charge" id="e_amount" name="e_amount">
            ...
            <div class="container mt-8 d-flex justify-content-center align-items-center col-4 ">
