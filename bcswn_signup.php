...
<h1 class="text-white text-center d-inline" style="padding: 20px; margin-top:5px;"><b class="text-center" style="text-shadow: 3px 3px 5px rgba(150, 150, 150, 1); font-size:3.5vw;">বিসিএস
	উইমেন নেটওয়ার্ক</b></h1> -->
                    ...
                    <div class="row col-12 m-0">
                        ...
                        <form action="" method="POST" enctype="multipart/form-data" class="col-12"
                                    ...
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_1_label"
                                                    style="font-size:2vw;">Section 1 : Login Information
                                                </p>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-6 pl-0">
                                                    ...
                                                    <input type="text" name="u_id" id="u_id"
                                                        value="<?php echo $W_ID; ?>" hidden>
                                                    <input type="text" name="pass" id="pass"
                                                        value="<?php echo $W_PASSWORD; ?>" hidden>
                                                    <input type="text" class="form-control" placeholder="Enter Name"
                                                        name="name" id="name" value="<?php echo  $W_NAME; ?>" required>
                                                ...
                                                <div class="form-group col-6 pl-0">
                                                    ...
                                                    <input type="text" maxLength="11" class="form-control" name="mobile"
                                                        id="mobile" value="<?php echo $W_MOBILE; ?>"
                                ...
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_2_label"
                                                    style="font-size:2vw;">Section 2 : Personal Information
                                                </p>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-lg-4 col-md-4 col-sm-12 pl-0">
                                                    ...
                                                    <label class="radio-inline">
                                                        <input type="radio" name="marrige" value="married"
                                                            <?php echo ($W_MARRIGE == 'married') ?  "checked" : "";  ?>>Married
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="marrige" value="divorced"
                                                            <?php echo ($W_MARRIGE == 'divorced') ?  "checked" : "";  ?>>Divorced
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="marrige" value="widow"
                                                            <?php echo ($W_MARRIGE == 'widow') ?  "checked" : "";  ?>>Widow
                                                    </label>
                                                    <label class="radio-inline">
                                                        <input type="radio" name="marrige" value="single"
                                                            <?php echo ($W_MARRIGE == 'single') ?  "checked" : "";  ?>>Single
                                                    </label>
                                ...
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            ...
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_3_label"
                                                    style="font-size:2vw;">Section 3 : My Picture Upload</p>
                                            </div>
                            ...
                            <div class="row container m-2" style="margin: 2px auto!important">
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_4_label"
                                                    style="font-size:2vw;">Section 4 : Address Information
                                                </p>
                                            </div>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            <input type="text" class="form-control" name="o_address"
                                                                id="office" placeholder="Office Address"
                                                                value="<?php echo  $W_OFFICE; ?>">
                                                    ...
                                                    <div class="form-group row ">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <select class="form-control" name="o_division"
                                                                id="o_division">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <select class="form-control" name="o_district"
                                                                id="o_district">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <select class="form-control" name="o_upazilla"
                                                                id="o_upazilla">
                                                    ...
                                                    <div class="form-group row ">
                                                        ...
                                                        <div class="col-6">
                                                            <div class="row">
                                                                <label for="residence"
                                                                    class="col-sm-4 col-form-label">Residence
                                                                    :</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        name="r_address" id="residence"
                                                                        placeholder="Residence Address"
                                                                        value="<?php echo  $W_RESIDENCE; ?>">
                                                                </div>
                                                            </div>
                                                            <!-- division starts  -->
                                                            <div class="row mt-2">
                                                                <label for="r_division"
                                                                    class="col-sm-4 col-form-label">Division
                                                                    :</label>
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" name="r_division"
                                                                        id="r_division">
                                                                        <option value="0">Select Division</option>
                                                                        <?php 
																																						for($i=0; $i<count($division); $i++){
                                                            ...
                                                            <!-- district starts  -->
                                                            <div class="row mt-2">
                                                                <label for="o_district"
                                                                    class="col-sm-4 col-form-label">District
                                                                    :</label>
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" name="r_district"
                                                                        id="r_district">
                                                                        <option value="0">Select District</option>
                                                            ...
                                                            <!-- Upazilla starts  -->
                                                            <div class="row mt-2">
                                                                <label for="o_upazilla"
                                                                    class="col-sm-4 col-form-label">Upazilla
                                                                    :</label>
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" name="r_upazilla"
                                                                        id="r_upazilla">
                                                                        <option value="0">Select Upazilla</option>
                                                        ...
                                                        <div class="col-6">
                                                            <div class="row">
                                                                <label for="parmanent"
                                                                    class="col-sm-4 col-form-label">Permanent
                                                                    :</label>
                                                                <div class="col-sm-8">
                                                                    <input type="text" class="form-control"
                                                                        name="p_address" id="parmanent"
                                                            ...
                                                            <!-- division starts  -->
                                                            <div class="row mt-2">
                                                                <label for="p_division"
                                                                    class="col-sm-4 col-form-label">Division
                                                                    :</label>
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" name="p_division"
                                                                        id="p_division">
                                                                        <option value="0">Select Division</option>
                                                                        <?php 
																																						for($i=0; $i<count($division); $i++){
                                                            ...
                                                            <!-- Upazilla starts  -->
                                                            <div class="row mt-2">
                                                                <label for="p_upazilla"
                                                                    class="col-sm-4 col-form-label">Upazilla
                                                                    :</label>
                                                                <div class="col-sm-8">
                                                                    <select class="form-control" name="p_upazilla"
                                                                        id="p_upazilla">
                                                                        <option value="0">Select Upazilla</option>
                            ...
                            <div class="row container m-2" style="margin: 2px auto!important">
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_5_label"
                                                    style="font-size:2vw;">Section 5 : Educational
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6 col-lg-6 col-sm-12 card">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <select id="inputState" name="s_examination"
                                                                    class="form-control">
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <select id="inputState" name="s_board"
                                                                    class="form-control">
                                                                    <option selected="selected" value="0">Select One
                                                                    </option>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <label>Roll : </label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Roll" name="s_roll" id="roll"
                                                                    value="<?php echo  $W_SSC_ROLL; ?>">
                                                            </div>

                                                            <label>Result : </label>
                                                            <div class="form-group ">

                                                                <select id="s_result" name="s_result"
                                                                    class="form-control">
                                                                ...
                                                                <input type="text" class="form-control mt-2 col-3"
                                                                    id="s_grade" name="s_grade">
                                                            </div>

                                                            <label>Group : </label>
                                                            <div class="form-group ">

                                                                <select id="inputState" name="s_group"
                                                                    class="form-control">
                                                                    <option selected="selected" value="0">Select One
                                                                    </option>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <select id="inputState" name="s_year"
                                                                    class="form-control">
                                                                    <option selected="selected" value="0">Select One
                                                                    </option>
                                                        ...
                                                        <div class="col-md-6 col-lg-6 col-sm-12 card">
                                                            <label class="form-label" style="font-weight: bold;"
                                                                for="education">H.S.C or Equivalent
                                                                :</label>
                                                            <label>Examination :</label>
                                                            <div class="form-group ">

                                                                <select id="inputState" name="h_examination"
                                                                    class="form-control">
                                                                    <option selected="selected" value="0">Select One
                                                                    </option>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <select id="inputState" name="h_board"
                                                                    class="form-control">
                                                                    <option selected="selected" value="0">Select One
                                                                    </option>
                                                                    <option value="Dhaka">Dhaka</option>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <label>Roll : </label>
                                                                <input type="text" class="form-control"
                                                                    placeholder="Batch" name="h_roll" id="batch"
                                                                    value="<?php echo  $W_BATCH; ?>">
                                                            </div>

                                                            <label>Result : </label>
                                                            <div class="form-group ">

                                                                <select id="h_result" name="h_result"
                                                                    class="form-control">
                                                                    <option value="0" selected="selected">Select
                                                                    </option>
                                                                    <option value="1st Division">1st Division</option>
                                                            ...
                                                            <div class="form-group ">
                                                                ...
                                                                <select id="inputState" name="h_group"
                                                                    class="form-control">
                                                                    <option selected="selected" value="0">Select One
                                                                    </option>
                                                                    <option value="Science">Science</option>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 col-lg-6 col-sm-12">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <select id="graduation" name="g_examination"
                                                                            class="form-control">
                                                                            <option value="0" selected="selected">Select
                                                                                One</option>
                                                                            <option value="1">B.Sc
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <select id="subject" name="g_subject"
                                                                            class="form-control">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <select id="inputState" name="g_university"
                                                                            class="form-control">
                                                                            <option value="0" selected="selected">Select
                                                                                One</option>
                                                                ...
                                                                <div class="col-md-6 col-lg-6 col-sm-12">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <select id="g_result" name="g_result"
                                                                            class="form-control">
                                                                            <option value="0" selected="selected">Select
                                                                                One</option>
                                                                        ...
                                                                        <input type="text"
                                                                            class="form-control mt-2 col-3" id="g_grade"
                                                                            name="g_grade">
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <select id="inputState" class="form-control">
                                                                            <option selected="selected" name="g_year"
                                                                                value="0">Select
                                                                                One</option>
                                                                            <option value="2001">2001</option>
                                                                            <option value="2002">2002</option>
                                                                    ...
                                                                    <div class="form-group ">
                                                                        ...
                                                                        <select id="g_duration" name="g_duration"
                                                                            class="form-control">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6 col-lg-6 col-sm-12">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <select id="master" name="m_examination"
                                                                        class="form-control">
                                                                        <option value="0" selected="selected">Select One
                                                                        </option>
                                                                        <option value="1">B.Sc
                                                                            (Engineering/Architecture)</option>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <select id="subject1" name="m_subject"
                                                                        class="form-control">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <select id="inputState" name="m_university"
                                                                        class="form-control">
                                                                        <option value="0" selected="selected">Select One
                                                                        </option>
                                                                        <option value="503">Ad-din Womens Medical
                                                            ...
                                                            <div class="col-md-6 col-lg-6 col-sm-12">
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <input type="number" class="form-control mt-2 col-3"
                                                                        id="m_grade" name="m_grade">
                                                                </div>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <select id="inputState" name="m_year"
                                                                        class="form-control">
                                                                        <option selected="selected" value="0">Select One
                                                                        </option>
                                                                        <option value="2001">2001</option>
                                                                ...
                                                                <div class="form-group ">
                                                                    ...
                                                                    <select id="inputState" name="m_duration"
                                                                        class="form-control">
                                                                        <option value="0">Select One</option>
                                                                        <option value="02 Years">02 Years</option>
                                                                        <option value="03 Years">03 Years</option>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-sm-12 ">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="skill" class="form-control"
                                                        placeholder="Language Skills" name="skill" id="skill"
                                                        value="<?php echo  $W_SKILL; ?>">
                                                </div>
                                                <!-- skill ends  -->
                                            </div>
                            ...
                            <div class="row container m-2" style="margin: 2px auto!important">
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_6_label"
                                                    style="font-size:2vw;">Section 6 : Interest & Hobbies</p>
                                            </div>
                            ...
                            <div class="row container m-2" style="margin: 2px auto!important">
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_7_label"
                                                    style="font-size:2vw;">Section 7 : Proffesional Records
                                                </p>
                                            </div>
                            ...
                            <div class="row container m-2" style="margin: 2px auto!important">
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_8_label"
                                                    style="font-size:2vw;">Section 8 : Proffesional
                                                    Membership</p>
                                            </div>
                                        ...
                                        <div class="card-body" id="section_8_content">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="membership">Proffesional
                                                    Membership:</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Proffesional Membership" name="membership"
                                                    id="membership" value="<?php echo  $W_MEMBERSHIP; ?>">
                                            </div>
                                            <!-- membership ends  -->
                                        </div>
                            ...
                            <div class="row container m-2" style="margin: 2px auto!important">
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_9_label"
                                                    style="font-size:2vw;">Section 9 : Honors & Awards
                                                    Received</p>
                                            </div>
                                        ...
                                        <div class="card-body" id="section_9_content">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="honor">Honors & Awards
                                                    Received:</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Honors & Awards Received" name="honor" id="honor"
                                                    value="<?php echo  $W_HONOR; ?>">
                                            </div>
                                            <!-- honor ends  -->
                            ...
                            <div class="row container m-2" style="margin: 2px auto!important">
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_10_label"
                                                    style="font-size:2vw;">Section 10 : Publications &
                                                    Articles</p>
                                            </div>
                                        ...
                                        <div class="card-body" id="section_10_content">
                                            ...
                                            <div class="form-group">
                                                <label class="form-label" for="article">Publications &
                                                    Articles:</label>
                                                <input type="text" class="form-control"
                                                    placeholder="Publications & Articles" name="article" id="article"
                                                    value="<?php echo  $W_ARTICLE; ?>">
                                            </div>
                                            <!-- article ends  -->
                            ...
                            <div class="row container m-2" style="margin: 2px auto!important">
                                <div class="col-12">
                                    <div class="card " style="width: 95%">
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_11_label"
                                                    style="font-size:2vw;">Section 11 : Family Information</p>
                                            </div>
                                        </div>
                                        <div class="card-body" id="section_11_content">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <label>Boy/s :</label>
                                                        <input type="number" min="0" class="form-control col-6"
                                                            placeholder="Number Of Boy" name="child_boy" id="child"
                                                            value="<?php echo  $W_CHILD; ?>">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        <label>Girl/s :</label>
                                                        <input type="number" min="0" class="form-control col-6"
                                                            placeholder="Number Of Girl" name="child_girl" id="child"
                                                            value="<?php echo  $W_CHILD; ?>">
                                        ...
                                        <div class="card-header " style="background-color: #C0C0C0!important;">
                                            <div class="d-flex justify-content-center align-items-center">
                                                <p class="section_part btn btn-link" id="section_12_label"
                                                    style="font-size:2vw;">Section 12 : My Signature Upload
                                                </p>
                                            </div>
                            ...
                            <div class="container mt-4 col-4">
                                ...
                                <button type='submit' class='btn btn-md btn-primary btn-block' name='submit'
                                    id='submit'> <b>
                                        Save</b></button>
                ...
                <footer class="footer mt-4 bg-dark"
                    style="font-weight: bold; text-shadow: 3px 3px 5px rgba(150, 150, 150, 1); ">
